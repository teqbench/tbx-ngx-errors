...
<dl>
    ...
    <dd>Authenticates with the <a href="https://docs.anthropic.com/en/api">Anthropic API ↗</a>.</dd>
</dl>
...
Both the [GitHub Actions ↗](https://docs.github.com/en/actions) action and the [Claude Code ↗](https://github.com/anthropics/claude-code) CLI read the same `CLAUDE.md`, ensuring consistent behavior across local and CI environments.
